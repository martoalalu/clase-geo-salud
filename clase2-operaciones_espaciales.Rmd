...
# Yapa I: Contar puntos en polígonos
...
Como lo que queremos hacer es un choropleth de plazas en radios ahora solo nos resta agregar la columna de cantidad de plazas al dataframe que tiene el polígono de los radios censales. 
Hacemos un simple **left_join** por radio_id y listo!
...
¿Cuál es el barrio que más plazas tiene?
¿Podemos calcular la cantidad de plazas por km2?
¿Cuál es el barrio que tiene más km2 de espacio verde por habitante?
